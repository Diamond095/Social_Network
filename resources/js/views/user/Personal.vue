<template>
    <div class="w-96 mx-auto">
        <div class="mb-4">
            <div class=" mb-3">
                <input v-model="title" class="w-96 rounded-3xl border p-2 border-slate-300" type="text" placeholder="title">
            </div>
            <div class=" mb-3">
            ...
            <div>
                <a href="#" @click="createNewPost" class="block p-2 w-32 text-center rounded-3xl bg-green-600 text-white
...
export default {
    ...
    methods: {
        ...
        storeImage(e) {
            ...
            axios.post('/api/post_image', formData).then(
                res => {
